...
coordinates = [(str(random.uniform(0.0, 90.0)), str(random.uniform(0.0, 90.0))) for _ in range(30000)]
...
with open('venues_data_filter.json', 'w', encoding='utf-8') as f:
...
def process_property(venue):
    ...
    if name_id == "category.nationalPark":
...
with open('statistics_filter.json', 'w', encoding='utf-8') as f:
